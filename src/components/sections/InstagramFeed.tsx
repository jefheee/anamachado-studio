    ...
    <section className="py-section-gap px-container-padding bg-surface-container-lowest md:px-[8%]">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="w-full bg-surface-container-low rounded-lg border border-outline-variant p-8 flex items-center justify-center min-h-[300px]"
        >
          {/* Espaço reservado para o Widget do Instagram (ex: Elfsight) */}
          <div className="text-on-surface-variant flex flex-col items-center">
            ...
            <p className="font-body-md text-body-md text-center max-w-sm">
              [ Cole o script do feed do Instagram aqui ]<br />
